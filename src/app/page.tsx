	...
	const bind = useGesture({
		...
		onHover: ({ hovering }) => {
			if (!hovering) {
				setSpring({
					transform:
						"perspective(500px) rotateX(-5deg) rotateY(-20deg)",
					filter: "drop-shadow(10px 0px 0px rgba(0, 0, 0, 0.5))",
				});
			}
		},
		...
		<div>
			<div className="content">
				...
				<div className="main_info">
					...
					>
						<div
							className="info_content_box_text"
							style={infofontsize}
						>
							<h1 className="info_content_h1">
								Aily (AI Recycler)
							</h1>
							<div className="info_content_text_separater"></div>
							<p className="info_content_p">
								컴퓨터비전 AI를 활용한 자동 쓰레기분류장치 AIoT
								앱/웹 <br />
								&lt;2023 한국전자전 KES 출품&gt;{" "}
							</p>
						</div>
						<div className="info_content_box_image">
							<animated.img
								src="images/AilyLogo.png"
								className="info_content_box_image_example"
							/>
						</div>
					</animated.div>
					<animated.div
                ...
                <img alt='다운로드하기 Google Play' style={{ width: `100%` }} src='https://play.google.com/intl/en_us/badges/static/images/badges/ko_badge_web_generic.png' />
					...
					>
						...
						<div className="info_content_box_image">
							<animated.img
								src="images/CPRKiosk.png"
								className="info_content_box_image_example2"
							/>
						</div>
					</animated.div>
				</div>
