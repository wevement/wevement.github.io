    ...
    <div>
      <div className="content">
        ...
        <p className="ls2">
          ...
          <em className="emphasis">5</em>월 <em className="emphasis">2</em>부터 적용됩니다.
        </p>
        <br />
        <p className="lh6 bs4">
          <strong
        ...
        <p className="lh6 bs4">
          ...
          <em className="emphasis">&lt; 위브먼트 &gt;</em>은(는) 법령에 따른 개인정보
        ...
        <br /><br />
        <p className="lh6 bs4">
          <strong>제3조(처리하는 개인정보의 항목) </strong><br /><br />
          ① <em className="emphasis">&lt; 위브먼트 &gt;</em>은(는) 다음의 개인정보
          항목을 처리하고 있습니다.
        </p>
        <ul className="list_indent2 mgt10">
        ...
        <p className="ls2">
          <br /><br />① &lt;개인정보처리자명&gt;은(는) 만 14세 미만 아동에 대해
          개인정보를 수집할 때 법정대리인의 동의를 얻어 해당 서비스 수행에 필요한
          최소한의 개인정보를 수집합니다.
        </p>
        ...
        <p className="sub_p">
          ③ &lt;개인정보처리자명&gt;은(는) 만 1 4세 미만 아동의 개인정보를 수집할
          때에는 아동에게 법정대리인의 성명, 연락처와 같이 최소한의 정보를 요구할 수
          있으며, 다음 중 하나의 방법으로 적법한 법정대리인이 동의하였는지를
          확인합니다.
        </p>
        <p className="sub_p">
          • 동의 내용을 게재한 인터넷 사이트에 법정대리인이 동의 여부를 표시하도록
          하고 개인정보처리자가 그 동의 표시를 확인했음을 법정대리인의 휴대전화 문자
          메시지로 알리는 방법
        </p>
        <p className="sub_p">
          • 동의 내용을 게재한 인터넷 사이트에 법정대리인이 동의 여부를 표시하도록
        ...
        <p className="sub_p">
          • 동의 내용을 게재한 인터넷 사이트에 법정대리인이 동의 여부를 표시하도록
          하고 법정대리인의 휴대전화 본인인증 등을 통해 본인 여부를 확인하는 방법
        </p>
        <p className="sub_p">
          • 동의 내용이 적힌 서면을 법정대리인에게 직접 발급하거나, 우편 또는 팩스를
          통하여 전달하고 법정대리인이 동의 내용에 대하여 서명날인 후 제출하도록
          하는 방법
        </p>
        <p className="sub_p">
        ...
        <p className="sub_p">
          • 전화를 통하여 동의 내용을 법정대리인에게 알리고 동의를 얻거나 인터넷주소
          등 동의 내용을 확인할 수 있는 방법을 안내하고 재차 전화 통화를 통하여
          동의를 얻는 방법
        </p>
        <p className="sub_p">
        ...
        <ul className="list_indent2 mgt10">
          ...
          <li><em className="emphasis">개인정보를 제공받는 자 : 위브먼트</em></li>
          <li>
            <em className="emphasis"
        ...
        ><br /><br />
          ...
          <p className="ls2">
            <em className="emphasis"
            ><br />① &lt; 위브먼트 &gt; 은(는) 개인정보 보유기간의 경과, 처리목적
              달성 등 개인정보가 불필요하게 되었을 때에는 지체없이 해당 개인정보를
              파기합니다.<br /><br />② 정보주체로부터 동의받은 개인정보 보유기간이
              경과하거나 처리목적이 달성되었음에도 불구하고 다른 법령에 따라
              개인정보를 계속 보존하여야 하는 경우에는, 해당 개인정보를 별도의
              데이터베이스(DB)로 옮기거나 보관장소를 달리하여 보존합니다.<br />1.
              법령 근거 :<br />2. 보존하는 개인정보 항목 : 계좌정보, 거래날짜<br /><br />③
              개인정보 파기의 절차 및 방법은 다음과 같습니다.<br />1. 파기절차<br />
              &lt; 위브먼트 &gt; 은(는) 파기 사유가 발생한 개인정보를 선정하고, &lt;
              위브먼트 &gt; 의 개인정보 보호책임자의 승인을 받아 개인정보를
              파기합니다.<br
              /></em>
          </p>
          <p className="sub_p mgt10"><em className="emphasis">2. 파기방법</em></p>
          <p className="sub_p">
            <em className="emphasis"
          ...
          ><br /><br />
            ...
            <p className="sub_p">
              ② 제1항에 따른 권리 행사는위브먼트에 대해 「개인정보 보호법」 시행령
              제41조제1항에 따라 서면, 전자우편, 모사전송(FAX) 등을 통하여 하실 수
              있으며 위브먼트은(는) 이에 대해 지체 없이 조치하겠습니다.
            </p>
            <p className="sub_p">
            ...
            <p className="sub_p">
              ⑥ 위브먼트은(는) 정보주체 권리에 따른 열람의 요구, 정정·삭제의 요구,
            ...
            <p className="ls2">
              ...
              불러오는 ‘쿠키(cookie)’를 사용하지 않습니다.<br /><br />
            </p>
            <p className="lh6 bs4">
              <strong
            ...
            <table className="tb_board td_border_all tb_board_view tb_row mgt10">
              <caption>
                11. 행태정보의 수집·이용·제공 및 거부 등에 관한 사항 제공을 위해
              ...
              <tbody>
                <tr>
                  <th scope="row" className="bdl">수집하는 행태정보의 항목</th>
                  <th scope="row" className="bdl">행태정보 수집 방법</th>
                  <th scope="row" className="bdl">행태정보 수집 목적</th>
                  <th scope="row" className="bdl">
                    보유·이용기간 및 이후 정보처리 방법
                  </th>
                </tr>
                <tr>
                  <td className="txtc">앱 서비스 방문기록 및 방문시간</td>
                  <td className="txtc">앱 방문시 자동 수집</td>
                  <td className="txtc">이용자의 성향 및 맞춤형 서비스 제공</td>
                  <td className="txtc">수집일로부터 3년 이후 파기</td>
                </tr>
              </tbody>
            </table>
            <p className="sub_p"></p>
            <div className="panel_box panel_white">
              &lt;온라인 맞춤형 광고 등을 위해 제3자(온라인 광고사업자 등)가
              이용자의 행태정보를 수집·처리할수 있도록 허용한 경우&gt;
              <p></p>
              <p className="sub_p">
                ③ &lt;개인정보처리자&gt;은(는) 다음과 같이 온라인 맞춤형 광고
                사업자가 행태정보를 수집·처리하도록 허용하고 있습니다.
              </p>
              <p className="sub_p">
                - 행태정보를 수집 및 처리하려는 광고 사업자 : 구글 애드센스
              </p>
              <p className="sub_p">
                - 행태정보 수집 방법 : 이용자가 당사 웹사이트를 방문하거나 앱을
                실행할 때 자동 수집 및 전송
              </p>
              <p className="sub_p">
              ...
              <p className="sub_p">- 보유·이용기간 : 90일</p>
              <p className="sub_p"></p>
            </div>
            ④ &lt;개인정보처리자&gt;은(는) 온라인 맞춤형 광고 등에 필요한 최소한의
            행태정보만을 수집하며, 사상, 신념, 가족 및 친인척관계, 학력·병력, 기타
            사회활동 경력 등 개인의 권리·이익이나 사생활을 뚜렷하게 침해할 우려가
            있는 민감한 행태정보를 수집하지 않습니다.
            <p></p>
            <p className="sub_p">
              ⑤ &lt;개인정보처리자&gt;은(는) 만 14세 미만임을 알고 있는 아동이나
              만14세 미만의 아동을 주 이용자로 하는 온라인 서비스로부터 맞춤형 광고
              목적의 행태정보를 수집하지 않고, 만 14세 미만임을 알고 있는 아동에게는
              맞춤형 광고를 제공하지 않습니다.
            </p>
            <p className="sub_p">
              ⑥ &lt;개인정보처리자&gt;은(는) 모바일 앱에서 온라인 맞춤형 광고를
              위하여 광고식별자를 수집·이용합니다. 정보주체는 모바일 단말기의 설정
            ...
            <p className="sub_p">부서명 : 기획팀</p>
            <p className="sub_p">담당자 : 이인호</p>
            <p className="sub_p">연락처 : kbs@kakao.com</p>
            <br /><br />
            <p className="lh6 bs4">
              <strong
              ...
              <ul className="list_indent2 mgt10">
                <li className="tt">
                  ...
                  ><br /><br />
                    ...
                    <p></p>
                    <p className="sub_p">
                      ① 이 개인정보처리방침은 2023년 5월 2부터 적용됩니다.
                    </p>
                    <p className="sub_p"></p>
                    <p className="sub_p"></p>
                    <p className="sub_p"></p>
