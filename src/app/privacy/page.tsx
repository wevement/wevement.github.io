export default function Privacy() {
	...
	return (
		...
		>
			...
			&apos;wevement&apos;)은(는) 「개인정보 보호법」 제30조에 따라
			...
			<strong>
				&lt; 위브먼트 &gt;(&apos;https://www.wevement.com&apos;이하
				&apos;wevement&apos;)은(는) 다음의 목적을 위하여 개인정보를
			...
			1. &lt; 마케팅 및 광고에의 활용 &gt;
			<br />
			&lt; 마케팅 및 광고에의 활용 &gt;와 관련한 개인정보는 수집·이용에
			...
			<br />
			<br />
			&lt; 위브먼트 &gt;은(는) 다음의 개인정보 항목을 처리하고 있습니다.
			<br />
			&lt; 재화 또는 서비스 제공 &gt;
			<br />
			...
			<br />
			<br />
			② 또한, &lt; 개인정보처리자명 &gt;의 &lt; 처리목적 &gt; 관련 홍보를
			위해 아동의 개인정보를 수집할 경우에는 법정대리인으로부터 별도의
			동의를 얻습니다.
			<br />
			<br />
			③ &lt; 개인정보처리자명 &gt;은(는) 만 14세 미만 아동의 개인정보를
			수집할 때에는 아동에게 법정대리인의 성명, 연락처와 같이 최소한의
			...
			<br />
			<br />
			① &lt; 위브먼트 &gt; 은(는) 개인정보 보유기간의 경과, 처리목적 달성
			...
			<br />
			<br />
			① &lt; 개인정보처리자 &gt;은(는) 서비스 이용과정에서 정보주체에게
			최적화된 맞춤형 서비스 및 혜택, 온라인 맞춤형 광고 등을 제공하기
			...
			<br />
			<br />
			행태정보의 수집·이용·제공 및 거부 등에 관한 사항 제공을 위해
			...
			<strong>보유·이용기간 및 이후 정보처리 방법</strong>
			<br />
			앱 서비스 방문기록 및 방문시간 | 앱 방문시 자동 수집 | 이용자의 성향
			및 맞춤형 서비스 제공 | 수집일로부터 3년 이후 파기
			<br />
			...
			만14세 미만의 아동을 주 이용자로 하는 온라인 서비스로부터 맞춤형
			광고 목적의 행태정보를 수집하지 않고, 만 14세 미만임을 알고 있는
			...
			<br />
			<br />
			<strong>제13조(정보주체의 권익침해에 대한 구제방법)</strong>
			<br />
			...
			<br />① 이 개인정보처리방침은 2023년 5월 2부터 적용됩니다.
		</div>
	);
}
